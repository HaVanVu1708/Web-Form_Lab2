...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="CartList" AutoGenerateColumns="false" runat="server"
        ...
        SortExpression="ProductID" />
            ...
            <asp:TemplateField HeaderText="Quantity">
                <ItemTemplate>
                    ...
                    runat="server"  Text ="<%#: Item.Quantity %>">
    ...
    <table>
        <tr>
            <td>
                <asp:Button ID="UpdateBtn" OnClick="UpdateBtn_Click" Text="Update" runat="server" />
            </td>
             <td>
